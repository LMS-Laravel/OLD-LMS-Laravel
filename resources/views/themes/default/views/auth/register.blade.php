        ...
        <div class="form-group">
            <div class="col-xs-12">
                <div class="input-group">
                    ...
                    <input type="password" id="password" required name="password" class="form-control input-lg" placeholder="@trans('user::ui.register.password')">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-xs-12">
                <div class="input-group">
                    <span class="input-group-addon"><i class="gi gi-asterisk"></i></span>
                    <input type="password" id="password_confirmation" required name="password_confirmation" class="form-control input-lg" placeholder="@trans('user::ui.register.vpassword')">
                </div>
            </div>
        </div>
